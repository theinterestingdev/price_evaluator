...
window = Tk()
window.wm_title("Realtime Price Evaluator")
...
l8 =  Label(window, text="Loading.....", font=("courier", 30))
...
box5 =  Text(window, height=15, width=50, yscrollcommand=scrollbar.set, fg="blue", cursor="hand2")
box5.place(relx=0.8, rely=0.8, anchor="center")
